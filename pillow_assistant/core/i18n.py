...
_ZH = {
    ...
    "projects.switch": "切换到此项目对话",
    "projects.switch_chat": "切换到单次对话",
    "projects.current_badge": "● 当前",
    "projects.count": "{n} 个项目",
    "projects.turns": "{n} 轮对话",
    "projects.subtitle": "选择一个项目继续对话，或查看其历史与产物",
    "projects.in_progress_badge": "⏳ 进行中",
    "projects.in_progress_count": "{m} 个进行中",
    ...
    "tool.delproj.no_store": "当前环境没有项目存储",
    "tool.delproj.empty": "请提供要删除的项目名称或 id",
    "tool.delproj.not_found": "未找到项目：{name}",
    "tool.delproj.ambiguous": "找到多个匹配「{name}」的项目，请指明 id：\n{listing}",
    "tool.delproj.done": "已删除项目「{name}」（id={id}）",
    "tool.delproj.failed": "删除项目失败：{name}",
    "tool.delproj.current_cleared": "（该项目是当前对话所在项目，已切回单次对话）",
    # -- undo ------------------------------------------------------------------
    "undo.button": "撤销",
    ...
    "core.project_new": "（新建）",
    "core.chat_note": "💬 对话",
    "core.project_switch": "🔀 已切换到项目「{name}」继续（识别为延续过去的工作）",
    "triage.confirm_switch": "这看起来是项目「{name}」的延续，切换到该项目继续吗？",
    "triage.yes_switch": "切换并继续",
    "triage.no_chat": "不用，按普通对话",
    "core.max_steps": "\n[已达到最大步数，先停一下。回复「继续」可保留现场接着做]",
    "core.answer_sep": "\n\n—— 回答 ——\n",
    "loop.step": "\n🔧 第 {k}/{n} 步 · {name}…\n",
    "tool.status.processing": "正在处理…",
    "tool.status.running": "步骤 {step}/{total} · 正在执行 {name}…",
    "tool.status.waiting": "等待确认 · {name}",
    "tool.status.permission": "权限请求",
    "tool.status.ok": "工具完成 · {name}\n{result}",
    "tool.status.failed": "工具失败 · {name}\n{result}",
    "tool.status.error": "执行错误\n{result}",
    ...
    "tool.skill.merged": "（已合并嵌套子技能：{names}）",
    "skill.nest_extends": "—— 继承自技能「{name}」 ——",
    "skill.nest_includes": "—— 引入技能「{name}」 ——",
    "skill.nest_cycle": "（检测到循环引用，已跳过技能「{name}」）",
    "skill.nest_missing": "（未找到被引用的技能「{name}」，已跳过）",
    "skill.nest_depth": "（嵌套层级过深，停止继续展开）",
    ...
    "tool.ask.multi": "是否允许多选（用户可勾选多个选项，并可在「其他」里补充）",
    ...
    "ask.cancel": "取消",
    "ask.other": "其他（自己输入）",
    "ask.other_ph": "其他：补充你的内容…",
    "ask.join_sep": "、",
    "ask.multi_hint": "可多选；也可在下方补充其他内容",
}
...
_EN = {
    ...
    "projects.switch": "Switch chat to this project",
    "projects.switch_chat": "Switch to one-off chat",
    "projects.current_badge": "● current",
    "projects.count": "{n} projects",
    "projects.turns": "{n} turns",
    "projects.subtitle": "Pick a project to continue its conversation, or view its history and artifacts",
    "projects.in_progress_badge": "⏳ in progress",
    "projects.in_progress_count": "{m} in progress",
    "projects.delete": "Delete project",
    "projects.delete_confirm_title": "Delete project",
    "projects.delete_confirm": "Delete project \"{name}\"?\nIts conversation history and all artifact files will be permanently removed and cannot be recovered.",
    "projects.delete_done": "Deleted project \"{name}\"",
    "projects.delete_failed": "Delete failed: {name}",
    "tool.delproj.desc": "Permanently delete a project (including its conversation history and all artifact "
                         "files; not recoverable). Use when the user explicitly asks to delete a project; "
                         "locate it by name or id, and list candidates when several match.",
    "tool.delproj.name": "name (or id) of the project to delete",
    "tool.delproj.no_store": "No project storage in this environment",
    "tool.delproj.empty": "Provide the name or id of the project to delete",
    "tool.delproj.not_found": "Project not found: {name}",
    "tool.delproj.ambiguous": "Several projects match \"{name}\"; specify an id:\n{listing}",
    "tool.delproj.done": "Deleted project \"{name}\" (id={id})",
    "tool.delproj.failed": "Failed to delete project: {name}",
    "tool.delproj.current_cleared": " (it was the current conversation's project; switched back to one-off chat)",
    "undo.button": "Undo",
    ...
    "core.chat_note": "💬 Chat",
    "core.project_switch": "🔀 Switched to project \"{name}\" to continue (recognized as continuing past work)",
    "triage.confirm_switch": "This looks like a continuation of project \"{name}\". Switch to it and continue?",
    "triage.yes_switch": "Switch and continue",
    "triage.no_chat": "No, just chat",
    "core.max_steps": "\n[max steps reached, pausing — reply \"continue\" to resume with full context]",
    "core.answer_sep": "\n\n—— Answer ——\n",
    "loop.step": "\n🔧 step {k}/{n} · {name}…\n",
    "tool.status.processing": "Processing…",
    "tool.status.running": "Step {step}/{total} · Running {name}…",
    "tool.status.waiting": "Waiting for confirmation · {name}",
    "tool.status.permission": "permission request",
    "tool.status.ok": "Tool complete · {name}\n{result}",
    "tool.status.failed": "Tool failed · {name}\n{result}",
    "tool.status.error": "Execution error\n{result}",
    ...
    "tool.skill.merged": "(merged nested sub-skills: {names})",
    "skill.nest_extends": "—— inherited from skill \"{name}\" ——",
    "skill.nest_includes": "—— includes skill \"{name}\" ——",
    "skill.nest_cycle": "(circular reference detected; skipped skill \"{name}\")",
    "skill.nest_missing": "(referenced skill \"{name}\" not found; skipped)",
    "skill.nest_depth": "(nesting too deep; stopped expanding)",
    ...
    "tool.ask.multi": "whether to allow multi-select (user can check several options and add their own under \"Other\")",
    ...
    "ask.other_ph": "Other: add your own…",
    "ask.join_sep": ", ",
    "ask.multi_hint": "Pick any number; you can also add your own below",
}
